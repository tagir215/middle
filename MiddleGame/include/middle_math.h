...
// TODO CHECK END OF THE FILE, TRY CLEAN UP AT SOME POINT
...
#define EPSILON 0.000001f
	...
	inline Vector2 Vector2Min(Vector2 v1, Vector2 v2)
	{
		Vector2 result = { 0 };
	...
	inline Vector2 Vector2Max(Vector2 v1, Vector2 v2)
	{
		Vector2 result = { 0 };
...
#define EPSILON 0.000001f
	...
	inline Vector2 Vector2Refract(Vector2 v, Vector2 n, float r)
	{
		Vector2 result = { 0 };
	...
	// Move Vector towards target
	inline Vector3 Vector3MoveTowards(Vector3 v, Vector3 target, float maxDistance)
	{
		Vector3 result = { 0 };
	...
	inline Vector3 Vector3CubicHermite(Vector3 v1, Vector3 tangent1, Vector3 v2, Vector3 tangent2, float amount)
	{
		Vector3 result = { 0 };
...
#define EPSILON 0.000001f
	...
	inline Vector4 Vector4One(void)
	{
	...
	inline Vector4 Vector4AddValue(Vector4 v, float add)
	{
		Vector4 result = {
			v.x + add,
			v.y + add,
	...
	inline Vector4 Vector4Subtract(Vector4 v1, Vector4 v2)
	{
		Vector4 result = {
			v1.x - v2.x,
			v1.y - v2.y,
	...
	inline Vector4 Vector4SubtractValue(Vector4 v, float add)
	{
		Vector4 result = {
			v.x - add,
			v.y - add,
	...
	inline float Vector4LengthSqr(Vector4 v)
	{
		float result = (v.x * v.x) + (v.y * v.y) + (v.z * v.z) + (v.w * v.w);
		return result;
	}

	inline float Vector4DotProduct(Vector4 v1, Vector4 v2)
	{
	...
	// Calculate distance between two vectors
	inline float Vector4Distance(Vector4 v1, Vector4 v2)
	{
		float result = sqrtf(
	...
	// Calculate square distance between two vectors
	inline float Vector4DistanceSqr(Vector4 v1, Vector4 v2)
	{
		float result =
			(v1.x - v2.x) * (v1.x - v2.x) + (v1.y - v2.y) * (v1.y - v2.y) +
			(v1.z - v2.z) * (v1.z - v2.z) + (v1.w - v2.w) * (v1.w - v2.w);
	...
	inline Vector4 Vector4Scale(Vector4 v, float scale)
	{
	...
	// Multiply vector by vector
	inline Vector4 Vector4Multiply(Vector4 v1, Vector4 v2)
	{
	...
	// Negate vector
	inline Vector4 Vector4Negate(Vector4 v)
	{
	...
	// Divide vector by vector
	inline Vector4 Vector4Divide(Vector4 v1, Vector4 v2)
	{
		Vector4 result = { v1.x / v2.x, v1.y / v2.y, v1.z / v2.z, v1.w / v2.w };
		return result;
	}
	...
	// Get min value for each pair of components
	inline Vector4 Vector4Min(Vector4 v1, Vector4 v2)
	{
		Vector4 result = { 0 };
	...
	// Get max value for each pair of components
	inline Vector4 Vector4Max(Vector4 v1, Vector4 v2)
	{
		Vector4 result = { 0 };
	...
	// Calculate linear interpolation between two vectors
	inline Vector4 Vector4Lerp(Vector4 v1, Vector4 v2, float amount)
	{
		Vector4 result = { 0 };
	...
	// Move Vector towards target
	inline Vector4 Vector4MoveTowards(Vector4 v, Vector4 target, float maxDistance)
	{
		Vector4 result = { 0 };
	...
	// Invert the given vector
	inline Vector4 Vector4Invert(Vector4 v)
	{
	...
	// Check whether two given vectors are almost equal
	inline int Vector4Equals(Vector4 p, Vector4 q)
	{
#if !defined(EPSILON)
#define EPSILON 0.000001f
#endif
	...
	inline Matrix MatrixFrustum(double left, double right, double bottom, double top, double nearPlane, double farPlane)
	{
		Matrix result = { 0 };
...
#define EPSILON 0.000001f
	...
	// as described in the GLTF 2.0 specification: https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html#interpolation-cubic
	inline Quaternion QuaternionCubicHermiteSpline(Quaternion q1, Quaternion outTangent1, Quaternion q2, Quaternion inTangent2, float t)
	{
		float t2 = t * t;
		float t3 = t2 * t;
...
#define EPSILON 0.000001f
	...
	inline void MatrixDecompose(Matrix mat, Vector3* translation, Quaternion* rotation, Vector3* scale)
	{
		// Extract translation.
	...
	inline Vector3 gridPosition(const Vector3& point, int gridSize) {
		Vector3 result;
	...
	inline bool PointInsideSphere(const Vector3& point, const Vector3& spherePos, float radius) {
		float sqDist = Vector3DistanceSqr(point, spherePos);
		return sqDist < radius * radius;
	}

	inline bool RayCastLineSphere(const Vector3& spherePos, float radius, const Vector3& rayStart, const Vector3& rayEnd, Vector3& outIntersectPos) {
	...
	inline bool PointIntersectLineZX_Plane(const Vector3& pointPos, const Vector3& lineA, const Vector3& lineB, float paddingH, float paddingV) {
	...
	inline Vector3 RayCastLinePlane(const Vector3& planePos, const Vector3& planeNormal, const Vector3& rayStart, const Vector3& rayDir) {
