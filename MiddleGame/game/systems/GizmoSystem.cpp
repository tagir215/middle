...
public:
	...
	bool broadTest(middle::GameState* gameState, const midMath::Vector3& spherePos, float radius) {
		midMath::Vector3 rayStart = gameState->mouseState.mouseNearPlanePos;
		midMath::Vector3 rayEnd = rayStart + midMath::Vector3Scale(gameState->mouseState.mouseDir, 10000);
	...
	AxisTestResult axisTest(middle::GameState* gameState, const midMath::Vector3& spherePos, float radius) {
		midMath::Vector3 rayStart = gameState->mouseState.mouseNearPlanePos;
		midMath::Vector3 rayDir = gameState->mouseState.mouseDir;
