...
def generate_obj(name, indexA, indexB, target_distance):
    ...
    with open(path_to_array, "r") as f:
        ...
        for line in lines:
            ...
            if inside_array and 'end' in line:
                ...
                processed_lines.append(f"\tconstraint({name},\n");
                processed_lines.append(f"\t\t{indexA},\n")
                processed_lines.append(f"\t\t{indexB},\n")
                processed_lines.append(f"\t\t{target_distance},\n")
...
if __name__ == '__main__':
    ...
    indexA = sys.argv[2]
    indexB = sys.argv[3]
    target_distance = sys.argv[4]
    generate_obj(name, indexA, indexB, target_distance)
    #build()
    print("object added")
