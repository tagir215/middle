	...
	void update(middle::GameState* gameState) override {
		...
		if (gameState->applicationMode == middle::ApplicationMode::GAME_MODE) {
			...
			if (gameState->inputBlockers.find(middle::InputBlockers::KEYBOARD_BLOCK) == gameState->inputBlockers.end()) {
				...
				ei.f1Held = IsKeyDown(KEY_F1);
				ei.f2Held = IsKeyDown(KEY_F2);
				ei.f3Held = IsKeyDown(KEY_F3);
				ei.f4Held = IsKeyDown(KEY_F4);
				ei.f5Held = IsKeyDown(KEY_F5);
				ei.f6Held = IsKeyDown(KEY_F6);
				ei.f7Held = IsKeyDown(KEY_F7);
				ei.f8Held = IsKeyDown(KEY_F8);
				ei.f9Held = IsKeyDown(KEY_F9);
				ei.f10Held = IsKeyDown(KEY_F10);
				ei.f11Held = IsKeyDown(KEY_F11);
				ei.f12Held = IsKeyDown(KEY_F12);
